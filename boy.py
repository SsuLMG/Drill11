...
class Idle:
    ...
    @staticmethod
    def draw(boy):
        boy.image.clip_draw(int(boy.frame % 5) * 184, (2 - boy.action) * 167, 183, 167, boy.x, boy.y, 184, 170)
...
class Sleep:
    ...
    def draw(boy):
        if boy.face_dir == -1:
            ...
            boy.image.clip_composite_draw(int(boy.frame % 5) * 184, (2-boy.action) * 167, 183, 167, 0, 'h', boy.x, boy.y, 184, 170)
